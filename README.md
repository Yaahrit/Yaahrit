...
```java
public class YashRaj extends Developer {
    ...
    private final String[] currentlyLearning = { "Spring Boot", "System Design", "REST APIs" };
    private final String[] interests         = { "Full-Stack Development", "AI Integration", "Open Source" };
    private final String   funFact           = "I write better code after midnight ☕";

    @Override
    public String toString() {
        return "Passionate developer who loves turning complex problems into elegant solutions.";
    }
}
```
...
- 📬 **Reach me at** — [syashraj903@gmail.com](mailto:syashraj903@gmail.com)
...
<p align="center">
  ...
  <a href="mailto:syashraj903@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-syashraj903@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
</p>
